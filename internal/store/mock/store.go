...
import (
	...
	store "github.com/CimaCha/alice-skill/internal/store"
...
func (mr *MockMessageStoreMockRecorder) FindRecipient(ctx, username any) *gomock.Call {
...
func (mr *MockMessageStoreMockRecorder) GetMessage(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMessageStoreMockRecorder) ListMessages(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMessageStoreMockRecorder) SaveMessage(ctx, userID, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
